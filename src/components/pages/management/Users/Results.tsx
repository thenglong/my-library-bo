...
const applyFilters = (users: any[], query: any, filters: any) => {
...
const applyPagination = (users: any, page: any, limit: any) => {
  return users.slice(page * limit, page * limit + limit)
}

const Results = ({ users }: any) => {
  const [selectedItems, setSelectedUsers] = useState<any>([])
  ...
  const handleTabsChange = (_event: any, tabsValue: any) => {
    let value: any = null
  ...
  const handleSelectOneUser = (_event: any, userId: any) => {
    if (!selectedItems.includes(userId)) {
      setSelectedUsers((prevSelected: any) => [...prevSelected, userId])
    } else {
