...
const applyFilters = (products: any[], query: string) => {
...
const applyPagination = (products: any[], page: number, limit: number) => {
  return products.slice(page * limit, page * limit + limit)
}

const Results = ({ products }: { products: any[] }) => {
  const [selectedItems, setSelectedProducts] = useState<any>([])
  ...
  const handleSelectAllProducts = (event: any) => {
    setSelectedProducts(
      event.target.checked ? products.map((product: any) => product.id) : []
    )
  }

  const handleSelectOneProduct = (event: any, productId: any) => {
                  ...
                  {paginatedProducts.map((product) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <TableCell>
                          {product.categories.map((value: any) => {
                            return (
                              <span key={value}>
